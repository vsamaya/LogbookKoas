...
public class editprofil extends AppCompatActivity {
    ...
    private String UPLOAD_URL = "https://logbook.fk.undip.ac.id/koas/android/upload.php";
    private String HAPUS_URL = "https://logbook.fk.undip.ac.id/koas/android/hpsfoto.php";
    private static final String TAG = MainActivity.class.getSimpleName();
    private static final String TAG_SUCCESS = "success";
    private String simpan_url = "https://logbook.fk.undip.ac.id/koas/android/updateprofil.php";
    private String data_url = "https://logbook.fk.undip.ac.id/koas/android/getdataprofilms.php";
    private String data_url1 = "https://logbook.fk.undip.ac.id/koas/android/getdataprofilms1.php";
    public static final String KOTA_URL = "https://logbook.fk.undip.ac.id/koas/android/getKota.php";
    private String foto_image = "https://logbook.fk.undip.ac.id/koas/foto/";
    public static final String PROP_URL = "https://logbook.fk.undip.ac.id/koas/android/getpropkota.php";
