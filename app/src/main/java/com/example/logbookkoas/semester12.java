...
public class semester12 extends AppCompatActivity {
    ...
    ListView listView;
    String url = "http://192.168.1.4/logbook1/sem12.php";
    @Override
        ...
        JsonObjectRequest json = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(semester12.this, jumlaht, Toast.LENGTH_SHORT).show();
                    SimpleAdapter s4dap;
                    s4dap = new SimpleAdapter(semester12.this, MyArrList, R.layout.listview9, new String[]{"s1", "n", "mli", "sls", "st"}, new int[]{R.id.stase9, R.id.username9, R.id.tglmulai9, R.id.tglselesai9, R.id.status9});
                    listView.setAdapter(s4dap);
