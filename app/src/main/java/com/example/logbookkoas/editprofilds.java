...
public class editprofilds extends Activity {
    ...
    private String simpan_url = "http://192.168.1.7/logbook/updateprofilds.php";
    private String data_url = "http://192.168.1.7/logbook/getdatads.php";
    String url = "http://192.168.1.7/logbook/getidbagian.php";
