...
public class editprofilrs extends Activity {
                ...
                if (validateInputs()) {
                    ...
                    Handler h =new Handler() {
                        ...
                        public void handleMessage(Message msg) {
                            Intent i = new Intent(editprofilrs.this, ResidenActivity.class);
            ...
            public void onResponse(JSONObject response) {
                try {
                   ...
                   //   idcb.setText(idilm[2]);
                    ...
                    ArrayAdapter<String> bgnarr = new ArrayAdapter<String>(editprofilrs.this, android.R.layout.simple_spinner_item, bgnilmu);
