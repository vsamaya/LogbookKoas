...
public class semester11 extends AppCompatActivity {

    final ArrayList<HashMap<String, String>> MyArrList = new ArrayList<HashMap<String, String>>();
    private static final String KEY_USERNAME = "username";
    ListView listView;
    String url = "http://192.168.43.159/logbook/sem11.php";
  ...
  /*  private void getData() {
        ...
        JsonObjectRequest json = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONArray kota = response.getJSONArray("m111");
                    JSONArray kota1 = response.getJSONArray("stase2");
                    ...
                    SimpleAdapter s4dap;
                    s4dap = new SimpleAdapter(semester11.this, MyArrList, R.layout.listview9, new String[]{"s1","nim", "tgl_mulai", "tgl_selesai", "st"}, new int[]{R.id.stase9,R.id.username9, R.id.tglmulai9, R.id.tglselesai9, R.id.status9});
        ...
        JsonObjectRequest json = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    SimpleAdapter s4dap;
                    s4dap = new SimpleAdapter(semester11.this, MyArrList, R.layout.listview9, new String[]{"s1", "n", "mli", "sls", "st"}, new int[]{R.id.stase9, R.id.username9, R.id.tglmulai9, R.id.tglselesai9, R.id.status9});
                    listView.setAdapter(s4dap);
